...
[![Cases](https://img.shields.io/badge/Cases-631-blueviolet?style=flat-square)](docs/gallery.md)
...
> **Prompt as Code** ｜ AI 图像/视频提示词逆向工程案例库。收录 **631** 个社区公开案例（源自「条码帮·无限创意集市」），
> 每个案例保留 **配图 + 完整提示词 + 来源出处**，并按 14 个场景重新分类，结构化 JSON 可直接供 Agent / 脚本复用。
...
| 🎞️ [创意视频案例](docs/gallery.md#cat-video) | 27 | 图生视频 / 文生视频提示词（视频在线播放见集市站） |
